...
const getErrorBarParam = (self: Visual, d): { width: number, height: number, errorBarValue1: number, errorBarValue2: number } => {
...
const getTransformParam = (self: Visual, d, isBottomXAxis: boolean, isLeftYAxis: boolean): { transX, transY, rotate } => {
...
const renderUpperBoundLabel = (self: Visual, isBottomXAxis: boolean, isLeftYAxis: boolean, errorBarUpperBoundLabel, errorLabels, errorBarUpperBoundLabelG, errorBars) => {
...
const renderLowerBoundLabel = (self: Visual, isBottomXAxis: boolean, isLeftYAxis: boolean, errorBarLowerBoundLabel, errorLabels, errorBarLowerBoundLabelG, errorBars) => {
...
const formattingErrorBar = (
    ...
    renderUpperBoundLabel(self, isBottomXAxis, isLeftYAxis, errorBarUpperBoundLabel, errorLabels, errorBarUpperBoundLabelG, errorBars);
    renderLowerBoundLabel(self, isBottomXAxis, isLeftYAxis, errorBarLowerBoundLabel, errorLabels, errorBarLowerBoundLabelG, errorBars);
}
    ...
    (errorBarGSelection as any).join(
        (enter) => {
            const errorBarG = enter.append("g")
                ...
                .each(function (d: ILollipopChartRow) {
                    const { width, height, errorBarValue1, errorBarValue2 } = getErrorBarParam(self, d);
                    select(this).datum({ ...d, width: width, height: height, errorBarValue1, errorBarValue2, });
                })
                .attr("transform", function (d) {
                    const { transX, transY, rotate } = getTransformParam(self, d, isBottomXAxis, isLeftYAxis);
            ...
            formattingErrorBar(self, isBottomXAxis, isLeftYAxis, errorBars, errorLabels, false, errorBarG, errorBarLine, markerUse1, markerUse2, errorBarUpperBoundLabelG, errorBarUpperBoundLabel, errorBarLowerBoundLabelG, errorBarLowerBoundLabel);
        ...
        (update) => {
            ...
            formattingErrorBar(self, isBottomXAxis, isLeftYAxis, errorBars, errorLabels, true, errorBarG, errorBarLine, markerUse1, markerUse2, errorBarUpperBoundLabelG, errorBarUpperBoundLabel, errorBarLowerBoundLabelG, errorBarLowerBoundLabel);
