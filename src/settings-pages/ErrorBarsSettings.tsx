...
const UIByField = (
  configValues: IErrorBarsSettings,
  UPPER_BOUND_LIST: ILabelValuePair[],
  LOWER_BOUND_LIST: ILabelValuePair[],
...
const UIErrorStyles = (
  ...
  return <>
    ...
    >
      ...
      {UIErrorStylesExtended2(vizOptions, configValues, handleChange, handleColor)}

    </AccordionAlt >
  </>
}

const UIErrorStylesExtended2 = (
  vizOptions: ShadowUpdateOptions,
  configValues: IErrorBarsSettings,
  handleChange, handleColor
) => {
  ...
  return <>
    ...
    <ConditionalWrapper visible={configValues.isEnabled}>
      ...
      >
        ...
        {UIByField(configValues, UPPER_BOUND_LIST, LOWER_BOUND_LIST, handleCheckbox, handleChange)}
        {UIByPercentage(configValues, handleChange)}
        {UIExtended2(configValues, handleChange)}
      </AccordionAlt>

      {UIErrorStyles(vizOptions, configValues, handleChange, handleColor)}
      {UIErrorBand(vizOptions, configValues, handleChange, handleColor)}
      {UIErrorLabels(vizOptions, configValues, handleChange, handleCheckbox, handleColor)}
...
const ErrorBarsSettings = (props) => {
  ...
  return (
    <>
      {UIExtended1(vizOptions, shadow, configValues, UPPER_BOUND_LIST, LOWER_BOUND_LIST, MEASURES_LIST, setConfigValues, handleChange, handleCheckbox, handleColor, closeCurrentSettingHandler, applyChanges, resetChanges)}
    </>
  );
};
